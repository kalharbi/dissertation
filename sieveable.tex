...
\begin{figure*}[!t]
	\centering
	\includegraphics[width=17cm, height=7cm]{figures/sieveable-deep-search/architecture}
...
First, we use apktool\footnote{https://code.google.com/p/android-apktool}, an open-source reverse engineering tool, to decode the apps and obtain their source files.
