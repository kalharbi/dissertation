...
The analysis presented in this thesis is performed on closed source Android applications; hence we make use of a reverse engineering tool called \textit{apktool} \cite{apktool} to unpack APK files and decode their resources to their nearly original formats.
