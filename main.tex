...
\usepackage[dvipsnames]{xcolor}   % for some awesome colors
...
\definecolor{MyLightGrayColor}{HTML}{EFF0F1}
...
\reader{Prof.~Kenneth Anderson}		%  2nd person to sign thesis
\readerThree{Prof.~Shaun Kane}		%  3rd person to sign thesis
\readerFour{Prof. ~Qin Lv}  % not physically present to sign, so comment before printing
