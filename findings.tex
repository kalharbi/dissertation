...
In this section, through an analysis of permission usage changes, I explore patterns in permission usage changes over time.

I begin the analysis by looking at the apps that made changes to the requested permissions between two subsequent versions.
I found that, on average, for the apps that added permissions, they added 2.28 permissions (standard deviation is 1.98). 
For the apps that dropped permissions, they dropped 2.42 permissions on average (standard deviation is 2).
