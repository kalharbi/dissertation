...
It is also noticeable that it experienced a period of little popularity at some points in time but later gained a resurgence of interest after the release of an official library.

This analysis demonstrated the value of using a temporal analysis to studying design changes.
UI design changes may become more or less popular over time, but they may react positively to a major platform event.
This phenomena would not have been missed had we considered a single version of the app.
\begin{figure}[H]
