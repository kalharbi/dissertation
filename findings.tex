...
I presented a number of analyses in three main areas: design, accessibility, and security.
...
In security, I uncovered that apps with few downloads tend to request either a small number of permissions, which are common in ad libraries, or a rather large and unusual number of permissions compared to the apps with high download counts.
