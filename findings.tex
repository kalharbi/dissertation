...
Thus, the results of the previous queries are more accurate and can be used to quantify apps that do not label image buttons neither statically nor dynamically.
