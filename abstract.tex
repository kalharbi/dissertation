\abstract{ \OnePageChapter
	...
	As the number of applications continues to proliferate in marketplaces, the need to fully understand them is ever increasing.
	...
	As a result, the increasing number of application updates published to marketplaces has largely gone unobserved.
