\abstract{ \OnePageChapter
	...
	Furthermore, the increase number of application updates published to marketplace has largely gone unobserved.
	...
	This dissertation introduces a deep and longitudinal approach embodied in a scalable platform called \textit{Sieveable} with the goal of enabling deep and longitudinal analysis of the design and development of mobile applications.
	With Sieveable, one could quickly retrieve a sample from a large dataset of apps that meet certain criteria with respect to the meta-data, visual design, and source code in an integrated manner.
