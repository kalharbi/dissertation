\abstract{ \OnePageChapter
	...
	The perspective of existing marketplace search engines is generally limited to the apps' listing information and a single snapshot of the app. Such view ignores

	This dissertation introduces a deep search engine called \textit{Sieveable} for mobile app marketplaces with the goal of enabling deep and large-scale analysis of mobile applications. 
	With Sieveable, one could quickly retrieve a sample from a large corpus of apps that meet certain criteria with respect to the listing details data, the visual design data, and the source code data in an integrated manner.
